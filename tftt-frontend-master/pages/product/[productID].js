          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full ">
              ...
              <div className=" h-12 grid place-items-center">
                <div className="grid grid-cols-5 gap-8 mx-12">
                  <div
                    className="bg-[#D9D9D9] h-8 w-8 cursor-pointer border-2 border-gray-300"
                ...
                height={"500"}
                  ...
                  <div
                    className="bg-[#D9D9D9] h-8 w-8 cursor-pointer"
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button className="flex ml-auto text-white bg-yellow-300 hover:bg-yellow-500 border-0 py-2 px-6 focus:outline-none rounded">
                  Buy Now
                </button>
                <button className="flex ml-2 text-white bg-yellow-300 hover:bg-yellow-500 border-0 py-2 px-6 focus:outline-none rounded">
                  Add To Cart
                </button>
